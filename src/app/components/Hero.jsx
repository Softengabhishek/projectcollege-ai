...
const Hero = () => {
  return (
    <div
  className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20 bg-slate-700  dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
  <Link href="/"
  ...
  <h1
    ...
    <span className="relative whitespace-nowrap text-white-600 dark:text-gray-300"> Diagnose</span>
  ...
  <h2 className="mx-auto mt-12 max-w-xl text-lg sm:text-white-400 text-white-500 dark:text-gray-300 leading-7">
    Experience the future of diagnose with our cutting-edge AI tool. Our
    intelligent system streamlines and enhances every aspect of your health operations.
  </h2>
  <Link className="bg-orange-600 dark:bg-gray-800 rounded-xl text-white dark:text-gray-300 font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-orange-500 dark:hover:bg-gray-600 transition"
