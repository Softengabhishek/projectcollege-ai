                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-white truncate w-72">
                            E42, Block E Gamma 1 , Greater Noida (U.P), 201310 
                        </span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-white truncate w-72">+91 9598986151</span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 text-white truncate w-72">yourabhishekgupta@gmailcom</span>
                    </p>
                </div>
